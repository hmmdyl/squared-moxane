module moxane.graphics.redo.resources.effect;
...
struct EffectUniform
{
	...
	public void set(float* v, int num) { glUniform1fv(location, num, v); }

	public void set(Vector2f v) { glUniform2f(location, v.x, v.y); }
	public void set(Vector2f* v, int num = 1) { glUniform2fv(location, num, v.arrayof.ptr); }
	public void set(Vector2d v) { glUniform2d(location, v.x, v.y); }
	public void set(Vector2d* v, int num = 1) { glUniform2dv(location, num, v.arrayof.ptr); }
	void set(Vector2i v) { glUniform2i(location, v.x, v.y); }

	public void set(Vector3f v) { glUniform3f(location, v.x, v.y, v.z); }
	public void set(Vector3f* v, int num = 1) { glUniform3fv(location, num, v.arrayof.ptr); }
	public void set(Vector3d v) { glUniform3d(location, v.x, v.y, v.z); }
	public void set(Vector3d* v, int num = 1) { glUniform3dv(location, num, v.arrayof.ptr); }

	public void set(Vector4f v) { glUniform4f(location, v.x, v.y, v.z, v.w); }
	public void set(Vector4f* v, int num = 1) { glUniform4fv(location, num, v.arrayof.ptr); }
	public void set(Vector4d v) { glUniform4d(location, v.x, v.y, v.z, v.w); }
	public void set(Vector4d* v, int num = 1) { glUniform4dv(location, num, v.arrayof.ptr); }
...
class Effect
{
	...
	bool attachAndLink(Shader[] shader ...)
	{
		foreach(s; shader)
			attach(s);
		return link;
